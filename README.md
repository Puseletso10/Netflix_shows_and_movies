...
- Investigate the relationship between release year and movie duration
...
- Handling missing values (e.g., country, date_added)
- Converting date_added to datetime format
- Extracting year_added for time-based analysis
- Splitting and exploding multi-value columns (e.g., country, listed_in)
- Cleaning and converting duration into numeric format
...
- Pie chart (movies vs tv_shows)
- Bar charts (content type, countries, genres)
...
- Genre distribution highlights a strong preference for drama-related content.
- Rapid expansion of content occurred in recent years.
- Movie durations have remained stable despite increased production.
